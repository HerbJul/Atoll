//
//  CPUSensorCollector.swift
//  DynamicIsland
//
//  Ports the Stats project's CPU temperature and frequency readers.
//
...
final class CPUSensorCollector {
    ...
    deinit {
        if let subscription {
            let _ = IOReportCreateSamples(subscription, nil, nil) // best-effort flush
        }
    }
